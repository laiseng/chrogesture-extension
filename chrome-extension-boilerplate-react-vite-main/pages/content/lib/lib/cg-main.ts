...
export class CGMain {
  ...
  currentAnchorTarget: HTMLAnchorElement|null =null;
  indicatorElement: HTMLDivElement|null =null;
  ...
  listenToMouseEvents() {
    ...
    fromEvent<MouseEvent>(document, 'mousedown')
      ...
      .subscribe((e) => {
        ...
        // this.addDot(e);
        const currentCoordinate = this.getCoordinate(e);
        ...
        if (this.getDistance(this.anchorCoordinate, currentCoordinate) > MIN_LENGTH) {
          this.inGesture = true;
          const vector = this.getVector(this.getDegrees(this.anchorCoordinate, currentCoordinate));
          if (vector != null) {
  ...
  disablePointerEventOnClick(element: HTMLElement) {
    ...
    fromEvent<HTMLElement|null>(element.parentElement,  'mousedown')
      .pipe(
        tap((t) => console.log(t)),
